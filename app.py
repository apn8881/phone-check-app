...
with st.expander("💡 คู่มือการใช้งาน"):
    ...
    **ตัวเลือกไฟล์ TXT:**
    ...
    - 📋 **TXT - เบอร์โทรกับไฟล์ต้นทาง**: แสดงเบอร์โทรจัดกลุ่มตามไฟล์ต้นทาง
    
    ### 📋 รูปแบบไฟล์ TXT พร้อมรายละเอียด
    ```
    เบอร์โทรทั้งหมดในระบบ
    ==================================================
    วันที่ส่งออก: 2024-01-01 12:00:00
    ==================================================
    
    📁 ไฟล์: customers_january.xlsx
    ----------------------------------------
    0812345678
    0898765432
    0654321987
    
    📁 ไฟล์: customers_february.xlsx  
    ----------------------------------------
    0823456789
    0876543210
